#import "@preview/definitely-not-isec-thesis:2.1.0": *
...
#show: thesis.with(
  ...
  keywords: ([Broad keyword], [Keyword], [Specific Keyword],
	...
	kurzfassung: ( // Multi-language support
		"title": [Kurzfassung],
		"abstract": [
	...
	// END optionally removable
	list-of-sections: true,
